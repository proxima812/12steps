    ...
    <>
      <div className={twMerge("relative w-full max-w-full", classNameMainDiv)}>
        <div className="relative">
          <span
            className={twMerge(
              "absolute left-0 top-0 flex h-[48px] w-[48px] items-center justify-center rounded-2xl",
              classNameIcon,
            )}
          >
            <LoopIcon />
          ...
          <input
            ...
            className={twMerge(
              "h-[48px] w-full rounded-2xl bg-white py-3 pl-[62px] pr-5 focus:outline-none dark:bg-zinc-900",
              classNameSearch,
            )}
            type="text"
            value={query}
        ...
        {posts && posts.length > 0 && (
          <ul className="absolute top-[48px] z-50 w-full rounded-xl bg-white/80 p-3 backdrop-blur-md dark:bg-black/80">
            {query.length > 1 && (
